                        ...
                        <Card.Body>
                            ...
                            <div className=" p-3 rounded">
                                ...
                                <p style={{ fontSize: '0.97rem' }}>
                                    Sou desenvolvedor de software com experiência em diversas
                                    linguagens de programação, como Java, Python e C, aplicando
                                    boas práticas, refatoração de código e princípios de arquitetura
                                    limpa. No Frontend, atuo no desenvolvimento de interfaces
                                    dinâmicas e responsivas utilizando Vue.js e React, criando
                                    componentes reutilizáveis, gerenciando estados com Vuex e
                                    Redux, e integrando APIs RESTful e GraphQL.Também trabalho
                                    com Node.js para construir aplicações full-stack, desenvolvendo
                                    APIs eficientes com Express.js e Socket.io para funcionalidades em
                                    tempo real.
                                ...
                                <p style={{ fontSize: '0.97rem' }}>
                                    No Backend, tenho experiência com PHP e MySQL, desenvolvendo
                                    sistemas robustos com arquitetura MVC, queries otimizadas e
                                    stored procedures. Utilizo Laravel e Symfony para construção de
                                    APIs seguras e escaláveis, além de trabalhar com bancos de dados
                                    relacionais para manipulação de grandes volumes de dados,
                                    incluindo migrações, backups e otimização de consultas.
                                </p>
                                <p style={{ fontSize: '0.97rem' }}>
                                    Minha atuação em IoT e sistemas embarcados inclui o
                                    desenvolvimento de soluções com ESP32, ESP8266 e módulos
                                    GSM (SIM800L), integrando hardware e software por meio de
                                    bibliotecas como Firebase Arduino Client e Adafruit MQTT para
                                    comunicação em nuvem e monitoramento remoto. Além disso,
                                    possuo conhecimento em redes e protocolos de comunicação,
                                    como HL7, MQTT e HTTP, utilizando ferramentas como Wireshark e
                                    Netcat para análise de tráfego e troubleshooting.

                                </p>
                                <p style={{ fontSize: '0.97rem' }}>
                                    Sou adepto da modelagem de software com UML, aplicando
                                    diagramas de classe, sequência e casos de uso para melhorar a
                                    clareza e a manutenibilidade dos projetos. Minha abordagem
                                    combina raciocínio lógico, resolução de problemas complexos e
                                    proatividade, sempre buscando integrar novas tecnologias, como
                                    computação em nuvem e microsserviços, para criar soluções
                                    inovadoras.

                                </p>
                                <p style={{ fontSize: '0.97rem' }}>
                                    Estou constantemente me atualizando e buscando desafios que
                                    unam Frontend, Backend e sistemas embarcados, com foco em
